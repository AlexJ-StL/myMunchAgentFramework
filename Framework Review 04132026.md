...
3.  **Workflow Compliance:** The jMRI Loop (v2.0 Synthesis Workflow) described in AGENTS.md is reflected in the example playbooks, particularly in the v2_knowledge_replay playbook.
...
2.  **Broken Wiki References:**
  ...
  *  wiki/architecture/session-logic.md references src/auth/session.ts::validatefunc and src/auth/session.ts::generateHashfunc
...
4.  **Missing Generated Skills:**
  *  The examples mention generated skills (like skill-stripe.md in the docs_to_skill playbook), but the skills/generated/ directory doesn't exist and contains no files.
...
4.  **Implement Generated Skills Directory:** Create the skills/generated/ directory and ensure the docs_to_skill playbook actually generates files there.
